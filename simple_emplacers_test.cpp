...
Integer::Integer(const int& num) : m_num(num) {
}
...
int main() {
    ...
    std::transform(shuffleSet.begin(),
                   shuffleSet.end(),
                   emplacers::emplacer(otherSet, otherSet.begin()),
